...
class AccomodationScreen extends StatefulWidget {
  ...
  const AccomodationScreen({super.key, this.searchKeyword = ""});
...
class _AccomodationScreenState extends State<AccomodationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Nếu không tìm kiếm thì chỉ hiển thị tối đa 4 sản phẩm
        ...
        if (widget.searchKeyword.trim().isEmpty)
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  // TODO: Thêm logic điều hướng đến trang hiển thị tất cả phòng trọ
                },
