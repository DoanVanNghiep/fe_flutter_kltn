...
import 'package:vnua_service/main.dart';
              ...
              builder: (context, snapshot) {
                ...
                return ListView(
                  children: [
                    ...
                    ProfileMenuListTile(
                      text: S.of(context).generated_manage_posts,
                    ...
                    ProfileMenuListTile(
                      text: S.current.generated_top_up,
                      svgSrc: "assets/icons/Return.svg",
                      press: () {},
                    ),
                    ProfileMenuListTile(
                      text: S.current.generated_favorites,
                      svgSrc: "assets/icons/Wishlist.svg",
                      press: () {},
                    ),
                    ProfileMenuListTile(
                      text: S.current.generated_address,
                    ...
                    ProfileMenuListTile(
                      text: S.current.generated_payment,
                    ...
                    ProfileMenuListTile(
                      text: S.current.generated_wallet,
                    ...
                    Padding(
                      ...
                      child: Text("Cá nhân hoá",
                          style: Theme.of(context).textTheme.titleSmall),
                    ),
                    DividerListTileWithTrilingText(
                      svgSrc: "assets/icons/Notification.svg",
                      title: S.current.generated_notifications,
                      trilingText: "Tắt",
                      press: () {
                        Navigator.pushNamed(
                    ...
                    ProfileMenuListTile(
                      text: S.current.generated_settings,
                    ...
                    ProfileMenuListTile(
                      ...
                      press: () {
                        ...
                        if (appState != null) {
                          ...
                          debugPrint("Không tìm thấy MyAppState.");
                        }
                      },
                    ),
                    ProfileMenuListTile(
                      text: S.current.generated_location,
