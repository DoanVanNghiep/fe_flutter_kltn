...
class _CreatePostScreenState extends State<CreatePostScreen> {
      ...
      final Map<String, dynamic> postData = {
        ...
        "accomodation": {
          ...
          "gender": selectedMotelType == 'O_GHEP'
              ? (selectedGender == 'true' ? true : selectedGender == 'false' ? false : null)
              : null,
          ...
          children: [
            _buildCard(
              ...
              children: [
                ...
                _buildTextField(_contentController, 'Nội dung mô tả *', maxLines: 3),
              ],
            ),
            _buildCard(
              title: 'Giá và diện tích',
              children: [
                _buildTextField(_priceController, 'Giá cho thuê (VD: 1000000) *', keyboard: TextInputType.number),
                _buildTextField(_acreageController, 'Diện tích (m²) *', keyboard: TextInputType.number),
                _buildTextField(_electricController, 'Giá điện (đồng/kWh)', keyboard: TextInputType.number),
                _buildTextField(_waterController, 'Giá nước (đồng/m³)', keyboard: TextInputType.number),
              ],
            ),
            _buildCard(
              ...
              children: [
                ...
                const Text('Đặc điểm nổi bật', style: TextStyle(fontWeight: FontWeight.bold)),
                Wrap(
                  spacing: 10,
                  runSpacing: 8,
            ...
            ElevatedButton(
              ...
              child: loading
                  ...
                  : const Text('Tạo bài viết', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ),
  ...
  Widget _buildDropdownGender() {
    return Padding(
      ...
      child: DropdownButtonFormField<String>(
        ...
        decoration: const InputDecoration(labelText: 'Giới tính yêu cầu', border: OutlineInputBorder()),
        items: const [
  ...
  String _featureLabel(String key) {
    switch (key) {
      case 'interior': return 'Đầy đủ nội thất';
      case 'airConditioner': return 'Có điều hòa';
      case 'heater': return 'Có nóng lạnh';
      case 'internet': return 'Có internet';
      case 'toilet': return 'Vệ sinh khép kín';
      case 'time': return 'Giờ giấc tự do';
      case 'parking': return 'Có chỗ để xe';
      case 'security': return 'An ninh tốt';
      case 'owner': return 'Không chung chủ';
      case 'kitchen': return 'Kệ bếp';
      default: return key;
    }
  }
}
