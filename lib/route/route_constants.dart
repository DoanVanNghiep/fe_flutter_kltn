...
const String LayoutScreenRoute = "layout";
...
const String motelSearchRoute = "motel_search";
const String createPostRoute = "create_post";
const String managePostRoute = "manage_post";
const String updatePostRoute = "update_post";
